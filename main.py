...
def face_track(frame,):
    ...
    for (x, y, w, h) in faces:
        ...
        cv2.putText(frame, 'person', (w//2+x, y-h//5),
                    cv2.FONT_HERSHEY_PLAIN, 2.0, (255, 255, 255), 2, 1)
    cv2.putText(frame, "face count", (20, 60),
                cv2.FONT_HERSHEY_PLAIN, 2.0, (255, 255, 255), 2, 1)
    cv2.putText(frame, str(num_of_face), (230, 60), cv2.FONT_HERSHEY_PLAIN,
                2.0, (255, 255, 255), 2, 1)
    return frame
...
def updata_pic():
    ...
    while True:
        ...
        if ret:
            ...
            pic = face_track(pic)
            pic = water_track(pic,ui.checkBox.isChecked())
